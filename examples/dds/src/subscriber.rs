...
use dds::{
    cli,
    idl::ubx::{
        esf_alg::EsfAlg, esf_status::EsfStatus, hnr_att::HnrAtt, hnr_ins::HnrIns, hnr_pvt::HnrPvt,
        nav_pvt::NavPvt,
    },
};
...
fn main() {
    ...
    match topic_type.as_deref() {
        ...
        Some("HnrAtt") => {
            let h = ublox_topic_thread::<HnrAtt>(
                topic_name,
                key,
                &domain_participant,
                &subscriber,
        ...
        Some("HnrIns") => {
            let h = ublox_topic_thread::<HnrIns>(
                topic_name,
                key,
                &domain_participant,
                &subscriber,
